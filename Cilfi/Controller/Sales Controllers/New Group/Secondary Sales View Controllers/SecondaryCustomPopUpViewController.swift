//
//  SecondaryCustomPopUpViewController.swift
//  Cilfi
//
...
class SecondaryCustomPopUpViewController: UIViewController {
    ...
    @IBAction func addBtn(_ sender: UIButton) {
        if groupID != "" && itemID != "" && mrp != ""{
            if quantityTF.text != ""{
                ...
                Group.itemDiscount.append("0")
                
                self.performSegue(withIdentifier: "unwindToSSTable", sender: self)
