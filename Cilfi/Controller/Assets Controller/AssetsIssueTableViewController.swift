//
//  AssetsIssueTableViewController.swift
//  Cilfi
//
...
class AssetsIssueCell : MGSwipeTableCell{
...
class AssetsIssueTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "aicell", for: indexPath) as! AssetsIssueCell
        ...
        let approve = MGSwipeButton(title: "",icon: UIImage(named: "table-success"), backgroundColor: UIColor.flatGreen) {
            (sender: MGSwipeTableCell!) -> Bool in
            self.assets.setIssueData(assetType: "A", params: [self.getParams(index : indexPath.row, status : "A")], completion: { (returnType) in
        ...
        let reject = MGSwipeButton(title: "",icon: UIImage(named:"table-error"), backgroundColor: UIColor.flatRed) {
            (sender: MGSwipeTableCell!) -> Bool in
            self.assets.setIssueData(assetType: "A", params: [self.getParams(index : indexPath.row, status : "R")], completion: { (returnType) in
        ...
        cell.assetsLbl.text = "\(asset[indexPath.row]) (\(assetCode[indexPath.row]))"
