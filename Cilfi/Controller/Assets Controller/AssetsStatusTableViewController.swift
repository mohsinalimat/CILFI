//
//  AssetsStatusTableViewController.swift
//  Cilfi
//
...
class AssetsStatusCell : UITableViewCell{
...
class AssetsStatusTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ascell", for: indexPath) as! AssetsStatusCell
        ...
        cell.approveDateLbl.text = approvedDate[indexPath.row]
        cell.remarksLbl.text = remarks[indexPath.row]
            ...
            if response.result.isSuccess{
                ...
                do{
                    ...
                    for x in aStatus.asset{
                        ...
                        if let value = x.mgrTransactionDate{
                            let formatter = DateFormatter()
                            formatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ss"
                            if let date = formatter.date(from: value){
                                formatter.dateFormat = "dd MMMM yyyy"
